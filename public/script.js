...
const API_BASE_URL = "http://localhost:5000/api"; // Updated base URL for local development
...
async function getBotResponse(userInput) {
  try {
    const res = await fetch("http://localhost:5000/api/chatbot", { // Absolute URL for chatbot endpoint
      method: "POST",
      headers: { "Content-Type": "application/json" },
